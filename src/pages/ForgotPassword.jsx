    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-brand-navy to-slate-900 flex items-center justify-center p-4">
      <Card className="w-full max-w-md border-slate-200 bg-white/95 backdrop-blur">
        <CardHeader className="space-y-2">
          <CardTitle className="text-2xl">{t('passwordRecovery.forgot.title', 'Reset your password')}</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          {sent ? (
            <div className="flex flex-col items-center gap-4 py-6 text-center">
              ...
              <div>
                <p className="font-semibold text-slate-800 mb-1">{t('passwordRecovery.forgot.sentTitle', 'Email sent!')}</p>
