      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
        <button
          ...
          style={{
            ...
            fontFamily: 'Outfit,sans-serif', fontSize: 13, fontWeight: channel === 'slack' ? 600 : 500, cursor: 'pointer', transition: 'all .2s',
          }}
        >
        ...
        <button
          ...
          style={{
            ...
            fontFamily: 'Outfit,sans-serif', fontSize: 13, fontWeight: channel === 'teams' ? 600 : 500, cursor: 'pointer', transition: 'all .2s',
          }}
        >
          <svg viewBox="0 0 24 24" style={{ width: 16, height: 16, flexShrink: 0 }}>
        ...
        <div>
          ...
          <div style={{ background: 'rgba(255,255,255,.03)', border: '1px solid rgba(255,255,255,.08)', borderTop: '1px solid rgba(98,100,167,.15)', padding: 20, display: 'flex', flexDirection: 'column', gap: 18, minHeight: 340 }}>
            <div style={{ display: 'flex', gap: 10 }}>
              <div style={{ width: 32, height: 32, borderRadius: 8, background: 'linear-gradient(135deg,#6264A7,#9496c4)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Bricolage Grotesque',sans-serif", fontWeight: 800, fontSize: 13, color: '#fff', flexShrink: 0 }}>G</div>
              <div>
        ...
        <div className="hero-grid" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            ...
            <div style={{ padding: '24px 20px', background: 'rgba(58,141,255,.08)', border: '1px solid rgba(58,141,255,.15)', borderRadius: 14 }}>
              <div style={{ fontSize: 32, fontWeight: 800, color: '#3A8DFF', fontFamily: 'Bricolage Grotesque, sans-serif', letterSpacing: -1 }}>×4</div>
            ...
            <div style={{ padding: '24px 20px', background: 'rgba(255,255,255,.04)', border: '1px solid rgba(255,255,255,.08)', borderRadius: 14 }}>
              <div style={{ fontSize: 32, fontWeight: 800, color: 'white', fontFamily: 'Bricolage Grotesque, sans-serif', letterSpacing: -1 }}>−80%</div>
            ...
            <div style={{ padding: '24px 20px', background: 'rgba(58,141,255,.12)', border: '1px solid rgba(58,141,255,.2)', borderRadius: 14 }}>
              <div style={{ fontSize: 32, fontWeight: 800, color: '#3A8DFF', fontFamily: 'Bricolage Grotesque, sans-serif', letterSpacing: -1 }}>J+3</div>
          ...
          <div className="cards-3" style={{ marginTop: 32 }}>
            {setupCards.map((c) => (
              <div key={c.num} className="card sand rv">
                <div style={{ fontFamily: "'Bricolage Grotesque',sans-serif", fontWeight: 800, fontSize: 44, color: 'var(--navy)', opacity: .15, lineHeight: 1, marginBottom: 12 }}>{c.num}</div>
                <h3>{c.title}</h3>
                <p>{c.desc}</p>
              </div>
            ))}
