/**
 * Role-based UI gating tests.
 *
 * Tests the `findCurrentMember` helper and role-derived capabilities
 * used by the Team page, without mounting the full component (which
 * requires many API mocks).
 */
import { describe, it, expect } from 'vitest';

// Replicate the findCurrentMember logic from Team.jsx
